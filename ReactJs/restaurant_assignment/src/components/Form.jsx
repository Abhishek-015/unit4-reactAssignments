...
<div className="stars">
  ...
  <button className={`${filterState.rating === 4 ? 'isActive' : null}`} onClick={(e)=>{handlesorting(4)}}>4 Star</button>
  <button className={`${filterState.rating === 3 ? 'isActive' : null}`} onClick={(e)=>{handlesorting(3)}}>3 Star</button>
  <button className={`${filterState.rating === 2 ? 'isActive' : null}`} onClick={(e)=>{handlesorting(2)}}>2 Star</button>
  <button className={`${filterState.rating === 1 ? 'isActive' : null}`} onClick={(e)=>{handlesorting(1)}}>1 Star</button>
  <button className={`${filterState.rating === '' ? 'isActive' : null}`} onClick={(e)=>{handlesorting('')}}>All</button>
</div>
<div className="payment">
  <h5 className="sortrating">SORT BY PAYMENT</h5>
  <button className={`${filterState.method === 'card' ? 'isActive' : null}`} onClick={()=>{handlepayment("card")}}>Card Payment</button>
  <button className={`${filterState.method === 'cash' ? 'isActive' : null}`}  onClick={()=>{handlepayment("cash")}}>Cash Payment</button>
  <button className={`${filterState.method === 'upi' ? 'isActive' : null}`}  onClick={()=>{handlepayment("upi")}}>UPI Payment</button>
  <button className={`${filterState.method === 'all' ? 'isActive' : null}`}  onClick={()=>{handlepayment("all")}}>All</button>
</div>
<div className="sort">
<h5 className="sortrating">SORT</h5>
  <button onClick={sortByRatingFunc}>{sortByRating ? "High to Low rating" : "Low to High rating"}</button>
